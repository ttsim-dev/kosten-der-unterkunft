# Every Simulated Payout Rests on This
...
- **Schlüssiges Konzept** — where a Träger has published none, the
  Bundessozialgericht prescribes **Wohngeld-Höchstbetrag × 1.10**. That is the
  benchmark throughout, and it is legally correct rather than chosen.
